...
private:
    ...
    // Used to keep track of living variables for dead code elimination optimization pass on the AST
...
public:
    ...
    bool RemoveDead(std::vector<std::string>& live_list, bool lval);
};